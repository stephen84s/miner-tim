...
0.  **Process rules, before the task itself.**
    ...
    - **Break-testing binds you, not just the reviewer.** If you write a test to
      ...
      you thought of. Pass both arguments — scope is the difference between 33
