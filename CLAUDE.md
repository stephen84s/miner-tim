...
> migration renumbered everything, and GitLab #3, #4 and #7 were closed before
> it and were never imported — those take the explicit form `GitLab #N`. This
> note exists because stale cross-references have now been found in three
> separate review rounds, twice inside the commit that was fixing them.
